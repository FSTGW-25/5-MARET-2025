...
<body>
  <div class="title-box">12 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 17.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('Seventeen-Rock WIth You.mp3');
    ...
    const fullMessage = `"Jangan takut melangkah, bahkan ketika jalannya belum terlihat. 🌻 Setiap langkah kecil membawa kita lebih dekat pada tujuan." 🌼`;
